...
void DirectXPage::Preview_Click(Object^ sender, RoutedEventArgs^ e)
{
    ofApp* app = dynamic_cast<ofApp*>(ofGetAppPtr());
    app->setAlgorithm(CVAlgorithm::Preview);
}

void DirectXPage::Sepia_Click(Object^ sender, RoutedEventArgs^ e)
{
    ofApp* app = dynamic_cast<ofApp*>(ofGetAppPtr());
    app->setAlgorithm(CVAlgorithm::Sepia);
}

void DirectXPage::GrayScale_Click(Object^ sender, RoutedEventArgs^ e)
{
    ofApp* app = dynamic_cast<ofApp*>(ofGetAppPtr());
    app->setAlgorithm(CVAlgorithm::GrayScale);
}

void DirectXPage::Canny_Click(Object^ sender, RoutedEventArgs^ e)
{
    ofApp* app = dynamic_cast<ofApp*>(ofGetAppPtr());
    app->setAlgorithm(CVAlgorithm::Canny);
}

void DirectXPage::Blur_Click(Object^ sender, RoutedEventArgs^ e)
{
    ofApp* app = dynamic_cast<ofApp*>(ofGetAppPtr());
    app->setAlgorithm(CVAlgorithm::Blur);
}

void DirectXPage::Features_Click(Object^ sender, RoutedEventArgs^ e)
{
    ofApp* app = dynamic_cast<ofApp*>(ofGetAppPtr());
    app->setAlgorithm(CVAlgorithm::FindFeatures);
}
